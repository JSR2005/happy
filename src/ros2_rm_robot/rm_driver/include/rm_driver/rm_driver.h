...
#include "rm_ros_interfaces/msg/setforcepositionnew.hpp"
...
/**********************************************初始化需要用到的回调函数***********************************************/
    ...
    void Arm_Set_Force_Postion_new_Callback(const rm_ros_interfaces::msg::Setforcepositionnew::SharedPtr msg); 
    void Arm_Stop_Force_Postion_new_Callback(const std_msgs::msg::Empty::SharedPtr msg); 
    /*******************************坐标系回调函数******************************/
...
/************************************************************变量信息******************************************************/
    ...
    rclcpp::Publisher<std_msgs::msg::Bool>::SharedPtr Set_Force_Postion_new_Result;

    /************************************************设置力位混合控制************************************************/
    rclcpp::Subscription<rm_ros_interfaces::msg::Setforceposition>::SharedPtr Set_Force_Postion_Cmd;
    rclcpp::Subscription<rm_ros_interfaces::msg::Setforcepositionnew>::SharedPtr Set_Force_Postion_new_Cmd;
